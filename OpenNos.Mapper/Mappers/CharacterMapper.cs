...
namespace OpenNos.Mapper.Mappers
{
    public static class CharacterMapper
    {
        ...
        public static bool ToCharacter(CharacterDTO input, Character output)
        {
            ...
            output.IsBattleRoyalLevel = input.IsBattleRoyalLevel;//basto
            ...
            output.Prestige = input.Prestige;//basto
            output.PrestigeSaved = input.PrestigeSaved;//basto
            ...
            output.LevelSaved = input.LevelSaved;
            output.HeroLevelSaved = input.HeroLevelSaved;
            output.JobLevelSaved = input.JobLevelSaved;
            output.IsAdventurerAfterBattle = input.IsAdventurerAfterBattle;
            output.ReputationSaved = input.ReputationSaved;
            return true;
        }
