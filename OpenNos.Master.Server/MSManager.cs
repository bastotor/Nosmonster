    ...
    internal class MSManager
    {
        ...
        public MSManager()
        {
            ...
            ConfigurationObject = new ConfigurationObject
            {
                ...
                EstivalEvent = bool.Parse(ConfigurationManager.AppSettings["EstivalEvent"]),
                ValentineEvent = bool.Parse(ConfigurationManager.AppSettings["ValentineEvent"]),
                LunarNewYearEvent = bool.Parse(ConfigurationManager.AppSettings["LunarNewYearEvent"]),
                ...
                EnableTimeSpaceQuest = bool.Parse(ConfigurationManager.AppSettings["EnableTimeSpaceQuest"]),
