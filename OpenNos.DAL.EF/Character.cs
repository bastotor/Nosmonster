...
namespace OpenNos.DAL.EF
{
    public class Character
    {
        ...
        public ICollection<CharacterTitle> CharacterTitle { get; }
        ...
        public bool DisableHat { get; set; }

        public bool LockHud { get; set; }
        ...
        public bool IsBattleRoyalLevel { get; set; }//basto
        ...
        public int Prestige { get; set; }//basto

        public int PrestigeSaved { get; set; }//basto
        ...
        public byte LevelSaved { get; set; }

        public byte HeroLevelSaved { get; set; }

        public byte JobLevelSaved { get; set; }


        public bool IsAdventurerAfterBattle { get; set; }

        public long ReputationSaved { get; set; }


        public ICollection<CharacterActPart> CharacterActParts { get; internal set; }

        public short EffectTitle { get; set; }

        public short ViewTitle { get; set; }

        public byte TattooCount { get; set; }

        public int BattleTowerEXP { get; set; }

        public int BattleTowerStage { get; set; }

        public byte Act4ChannelCheck { get; set; }
