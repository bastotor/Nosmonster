...
namespace OpenNos.DAL.EF
{
    public class OpenNosContext : DbContext
    {
        ...
        public virtual DbSet<FishingLogEntity> FishingLogs { get; set; }

        public virtual DbSet<FishingSpotsEntity> FishingSpots { get; set; }

        public virtual DbSet<FishInfoEntity> FishInfo { get; set; }
