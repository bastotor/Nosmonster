...
namespace OpenNos.DAL
{
    public static class DAOFactory
    {
        ...
        private static IActDAO _actDAO;
        private static IActPartDAO _actPartDAO;
        ...
        public static IActDAO ActDAO => _actDAO ?? (_actDAO = new ActDAO());

        public static IActPartDAO ActPartDAO => _actPartDAO ?? (_actPartDAO = new ActPartDAO());
        ...
        public static IFishInfoDao FishInfoDao => _fishInfoDao ??= new FishInfoDao(); //basto
        ...
        public static object CharacterTitlesDAO { get; set; }
