            ...
            switch (packet.Runner)
            {
                ...
                case 15:
                    if (npc != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                case 1:
                                    Session.Character.SetRespawnPoint(2700, 57, 81); //Kentao (1,79,116)
                                    break;

                                case 20:
                                    Session.Character.SetRespawnPoint(2700, 57, 81);
                                    break;
                ...
                */
                ...
                case 301:
                    ...
                    {
                        Session.SendPacket("msg 2 You need to be at least Level 85 to join Cylloan.");
                        return;
                    }
                ...
                case 5001:
                    if (Session.Character.Level < 55)
                    {
                        Session.SendPacket("msg 2 You need to be at least Level 55 to join Glacernon.");
                        return;
                    }

                    if (Session.Character.Level > 54)
                    {
                        ServerManager.Instance.ChangeMap(Session.Character.CharacterId, 130, (short)(13 + ServerManager.RandomNumber(-3, 3)), (short)(40 + ServerManager.RandomNumber(-3, 3)));
                    }
                    break;
                ...
                case 5011:
                    ...
                    {
                        Session.SendPacket("msg 2 You need to be at least Level 70 to join Mortaz desert.");
                        return;
                    }

                    if (Session.Character.Level > 69)
                    {
                        ServerManager.Instance.ChangeMap(Session.Character.CharacterId, 170, (short)(127 + ServerManager.RandomNumber(-3, 3)), (short)(48 + ServerManager.RandomNumber(-3, 3)));
                    }
                    break;

                case 384:
                    if (Session.Character.Level < 99 || Session.Character.HeroLevel < 60)
                    {
                        Session.SendPacket("msg 2 You need to be at least Level 99+60 to join Dragonveil.");
                        return;
                    }

                    if (Session.Character.Level > 98 || Session.Character.HeroLevel > 59)
                    {
                        ServerManager.Instance.ChangeMap(Session.Character.CharacterId, 2700, (short)(55 + ServerManager.RandomNumber(-0, 0)), (short)(81 + ServerManager.RandomNumber(-0, 0)));
                    }
                    break;
                ...
                case 313:
                    ...
                    {
                        Session.SendPacket("msg 2 You need to be at least Level 70 to join Tart Hapendam.");
                    }
                    break;
                ...
                case 334:
                    if (npc != null)
                    {
                        ...
                        {
                            Session.SendPacket("msg 2 You need to be at least Level 88+10 to join act 7.");
                            return;
                        }
                ...
                case 5002:
                    ...
                    if (tp != null)
                    {
                        ...
                        if (ServerManager.Instance.ChannelId == 51)
                        {
                            ...
                            Session.Character.MapId = 2700; //kentao act4 teleporter
