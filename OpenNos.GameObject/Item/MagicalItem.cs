                                ...
                                else if (int.TryParse(packetsplit[6], out packetType))
                                {
                                    switch (packetType)
                                    {
                                        ...
                                        case 4:
                                            ...
                                            if (ServerManager.Instance.ChannelId == 51)
                                            {
                                                respawnObj.DefaultMapId = 130; //kentao act 4 kill (short)(129 + session.Character.Faction)
                                ...
                                else if (int.TryParse(packetsplit[6], out packetType))
                                {
                                    switch (packetType)
                                    {
                                        ...
                                        case 4:
                                            ...
                                            if (ServerManager.Instance.ChannelId == 51)
                                            {
                                                respawnObj.DefaultMapId = 130; //kentao act4 kill (short)(129 + session.Character.Faction)
                                                respawnObj.DefaultX = 41;
                                                respawnObj.DefaultY = 42;
                                            }
                                            if (respawnObj.DefaultX != 0 && respawnObj.DefaultY != 0 && respawnObj.DefaultMapId != 0)
