...
namespace OpenNos.GameObject
{
    public class MapInstance : BroadcastableBase
    {
        ...
        public MapInstance(Map map, Guid guid, bool shopAllowed, MapInstanceType type, InstanceBag instanceBag, bool dropAllowed = false)
        {
            ...
            if (type != MapInstanceType.TimeSpaceInstance && type != MapInstanceType.RaidInstance)
            {
                switch (map.MapId)
                {
                    ...
                    case 212: // Katol's Street
                        MinLevel = 90;
                        break;

                    case 233: // Hell's Gate 1
                        MinHeroLevel = 1;
                        break;

                    case 240: // Hell's Ruins 2
                        MinHeroLevel = 15;
                        break;
                    ...
                    case 2636: // Spirit Forest
                        MinHeroLevel = 35;
                        break;

                    case 2712: // A. Dragon's Lair
                        MinHeroLevel = 60;
                        break;

                    case 2707: // Gorge Path 1
                        MinHeroLevel = 70;
                        break;

                    case 4503: // map luina hl
                        MinHeroLevel = 70;
                        break;

                    case 2632: // map gold bl
                        MinHeroLevel = 1;
                        break;

                    case 2630: // map gold hl
                        MinHeroLevel = 70;
                        break;

                    case 2638: // map gold hl
                        MinHeroLevel = 80;
                        break;

                    case 130: //ACT4 Kentao
                        MinReputation = 125000000;
                        MinHeroLevel = 80;
                        break;

                    case 137: //ACT4 Kentao map xp1
                        MinReputation = 125000000;
                        MinHeroLevel = 80;
                        break;

                    case 135: //ACT4 Kentao map xp2
                        MinReputation = 150000000;
                        MinHeroLevel = 90;
                        break;

                    case 134: //ACT4 Kentao map raid
                        MinReputation = 175000000;
                        MinHeroLevel = 100;
                        break;

                    case 141: //ACT4 Kentao map farm
                        MinReputation = 150000000;
                        MinHeroLevel = 100;
                        break;

                    case 151: //ACT4 Kentao map farm reputation
                        MinHeroLevel = 90;
                        break;

                    case 150: //map farm reput bl
                        MinHeroLevel = 80;
                        break;
                }
            }
        ...
        public bool IsReputationMap //kentao reput control
        {
            get
            {
        ...
        public bool IsGoldMap //Kentao gold calcul par map
        {
            get
            {
                if (!IsScriptedInstance)
        ...
        public long MinReputation { get; set; } //Kentao reputation
        ...
        public void ThrowItems(Tuple<int, short, byte, int, int, short> parameter)
        {
            ...
            Observable.Timer(TimeSpan.FromSeconds(parameter.Item6)).Subscribe(s =>
            {
                for (int i = 0; i < parameter.Item3; i++)
                {
                    ...
                    {
                        destX = (short)(originX + ServerManager.RandomNumber(-5, 5));
                        destY = (short)(originY + ServerManager.RandomNumber(-5, 5));
                        if (Map.IsBlockedZone(destX, destY))
                        {
                            destX = (short)(originX + ServerManager.RandomNumber(-2, 2));
                            destY = (short)(originY + ServerManager.RandomNumber(-2, 2));
                            if (Map.IsBlockedZone(destX, destY))
                            {
                                destX = originX;
                                destY = originY;
