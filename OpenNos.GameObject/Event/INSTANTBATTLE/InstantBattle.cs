            ...
            public static void Run(Tuple<MapInstance, byte> mapinstance)
            {
                ...
                Observable.Timer(TimeSpan.FromMinutes(12)).Subscribe(X =>
                {
                    for (int d = 0; d < 180; d++)
                    {
                        ...
                        {
                            EventHelper.Instance.ScheduleEvent(TimeSpan.FromMinutes(0), new EventContainer(mapinstance.Item1, EventActionType.SPAWNPORTAL, new Portal { SourceX = 47, SourceY = 33, DestinationMapId = 2628 }));
                            ...
                            foreach (ClientSession cli in mapinstance.Item1.Sessions.Where(s => s.Character != null).ToList())
                            {
                                ...
                                cli.Character.GetReputation(cli.Character.HeroLevel * 10);
                                ...
                                cli.SendPacket(cli.Character.GenerateSay(string.Format(Language.Instance.GetMessageFromKey("WIN_BONUS_REPUT"), cli.Character.Level * 10), 10));
                ...
                switch (instantbattletype)
                {
                    case 1:
                        switch (wave)
                        {
                            ...
                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 20000));
                                dropParameters.AddRange(generateDrop(map, 1003, 10, 5));
                                dropParameters.AddRange(generateDrop(map, 1006, 10, 5));
                                dropParameters.AddRange(generateDrop(map, 1689, 2, 1));
                                break;
                        }
                        break;
                    ...
                    case 40:
                        switch (wave)
                        {
                            case 0:
                                ...
                                dropParameters.AddRange(generateDrop(map, 180, 5, 1));
                                dropParameters.AddRange(generateDrop(map, 5841, 3, 1));
                                break;
                            ...
                            case 2:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 25000));
                    ...
                    case 50:
                        switch (wave)
                        {
                            ...
                            case 3:
                                ...
                                dropParameters.AddRange(generateDrop(map, 1009, 10, 3));
                                dropParameters.AddRange(generateDrop(map, 1248, 5, 1));
                                dropParameters.AddRange(generateDrop(map, 1249, 2, 1));
                                dropParameters.AddRange(generateDrop(map, 1689, 2, 1));
                                break;
                        }
                        break;
                    ...
                    case 60:
                        switch (wave)
                        {
                            ...
                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 40000));
                            ...
                            case 2:
                                ...
                                dropParameters.AddRange(generateDrop(map, 1249, 1, 1));
                                break;

                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 70000));
                                ...
                                dropParameters.AddRange(generateDrop(map, 1249, 3, 1));
                                dropParameters.AddRange(generateDrop(map, 1689, 2, 1));
                                break;
                        }
                        break;
                    ...
                    case 70:
                        switch (wave)
                        {
                            ...
                            case 3:
                                ...
                                dropParameters.AddRange(generateDrop(map, 1248, 13, 1));
                                dropParameters.AddRange(generateDrop(map, 1029, 5, 1));
                                dropParameters.AddRange(generateDrop(map, 1249, 4, 1));
                                dropParameters.AddRange(generateDrop(map, 1689, 2, 1));
                                break;
                        }
                        break;
                    ...
                    case 80: //Kentao 
                        ...
                        {
                            case 0:
                                dropParameters.AddRange(generateDrop(map, 1046, 10, 300000));
                                dropParameters.AddRange(generateDrop(map, 9129, 15, 5));
                                dropParameters.AddRange(generateDrop(map, 5010, 3, 1));
                                dropParameters.AddRange(generateDrop(map, 1689, 3, 1));
                                break;

                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 500000));
                                dropParameters.AddRange(generateDrop(map, 9129, 15, 5));
                                dropParameters.AddRange(generateDrop(map, 2339, 10, 1));
                                dropParameters.AddRange(generateDrop(map, 5010, 5, 1));
                                dropParameters.AddRange(generateDrop(map, 1689, 5, 5));
                                break;

                            case 2:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 1000000));
                                dropParameters.AddRange(generateDrop(map, 9129, 20, 5));
                                dropParameters.AddRange(generateDrop(map, 2339, 10, 1));
                                dropParameters.AddRange(generateDrop(map, 5010, 7, 1));
                                dropParameters.AddRange(generateDrop(map, 1689, 7, 1));
                                break;

                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 20, 1000000));
                                dropParameters.AddRange(generateDrop(map, 9129, 30, 5));
                                dropParameters.AddRange(generateDrop(map, 2339, 10, 5));
                                dropParameters.AddRange(generateDrop(map, 5010, 10, 1));
                                dropParameters.AddRange(generateDrop(map, 1689, 10, 1));
                                break;
                        }
                        break;
                }
