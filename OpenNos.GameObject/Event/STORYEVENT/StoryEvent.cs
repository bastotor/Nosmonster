...
namespace OpenNos.GameObject.Event
{
    public static class StoryEvent
    {
        ...
        public static void GenerateStoryEvent()
        {
            ...
            ServerManager.Instance.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format("The story event will start in {0} minutes", 5), 0));
            ServerManager.Instance.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format("The story event will start in {0} minutes", 5), 1));
            Thread.Sleep(4 * 60 * 1000); //4 min
            ServerManager.Instance.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format("The story event will start in {0} minutes", 1), 0));
            ServerManager.Instance.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format("The story event will start in {0} minutes", 1), 1));
            Thread.Sleep(30 * 1000);
            ServerManager.Instance.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format("The story event will start in {0} seconds", 30), 0));
            ServerManager.Instance.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format("The story event will start in {0} seconds", 30), 1));
            Thread.Sleep(20 * 1000);

            ServerManager.Instance.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format("The story event will start in {0} seconds", 10), 0));
