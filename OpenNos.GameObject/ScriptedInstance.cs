...
namespace OpenNos.GameObject
{
    public class ScriptedInstance : ScriptedInstanceDTO
    {
        ...
        public byte HeroMinimumLevel { get; set; }

        public byte HeroMaximumLevel { get; set; }
        ...
        public ScriptedInstance instance { get; set; }
        ...
        public void LoadGlobals()
        {
            if (Script != null)
            {
                ...
                if (Model?.Globals != null)
                {
                    ...
                    LevelMaximum = Model.Globals.LevelMaximum?.Value ?? 255;
                    HeroMinimumLevel = Model.Globals.HeroLevelMinimum?.Value ?? 0;
                    HeroMaximumLevel = Model.Globals.HeroLevelMaximum?.Value ?? 255;
