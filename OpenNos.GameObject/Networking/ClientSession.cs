...
namespace OpenNos.GameObject
{
    public class ClientSession
    {
        ...
        public bool IsLocalhost => IpAddress.Contains("79.115.47.214");// i dont know because this is here
        ...
        {
            IEnumerable<Type> handlerTypes = !isWorldServer ? type.Assembly.GetTypes().Where(t => t.Name.Equals("NoS0575PacketHandler")) // shitty but it works
