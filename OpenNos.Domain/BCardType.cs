...
namespace OpenNos.Domain
{
    public static class BCardType
    {
        ...
        public enum CardType : byte
        {
           ...
           // HeroExpBuff = 87,
            ...
            WolfMaster = 97,
            IncreaseDamageVsEntity = 99,
            IncreaseDamageVsFaction = 100,
            IncreaseDamageVsMonsterInMap = 101, //basto
            IncreaseSlPoint = 102,
            SummonAct7 = 104,
            A7Powers1 = 105,
            A7Powers2 = 106,
    ...
    {
        public enum SummonAct7 : byte
        {
            SummoningFromArmor = 31,
            SummoningFromDefense = 21,
            NosmateAttackPower = 41,
        }
        public enum BuffInAttack : byte
        {
            LGWings = 11,
            GeneralInAttack = 21,
            GeneralPositiveInFefense = 31,
            PositiveInAttack = 41

        }
        public enum Tattoos : byte
        {
            RevertDamageFromPercent = 11,
            OverallAttackIncreasedByMagicDefense = 51
        }
        public enum SealedLodDamage : byte
        {

            ExtraDamageToVesselsAndGlacernon = 41,
            ExtraDamageToVesselsAndGlacernonNegated = 42
        }
        public enum IncreaseSlPoint : byte
        {
            IncreaseDamage = 11,
            IncreaseDefence = 21,
            IncreaseEllement = 31,
        ...
        public enum IncreaseDamageVsEntity : byte
        {
            IncreaseDamageVsPlants = 11,
            IncreaseDamageVsAnimals = 21,
            IncreaseDamageVsMonster = 31,
            IncreaseDamageVsKovolts = 41,
            IncreaseDamageVsCatsys = 51
        }
        public enum IncreaseDamageVsFaction : byte
        {
            IncreaseDamageVsSouls = 11, // ???
            IncreaseDamageVsAngel = 21,
            IncreaseDamageVsDevil = 31
        }
        public enum IncreaseDamageVsMonsterInMap : byte
        {
            IncreaseDamageInLod = 11,
            IncreaseDamageVsSealledMonster = 21,
            ExpIncreased = 31,
            JobExpIncrease = 41
        }
       ...
       /* public enum SpecialWeaponEffects : byte
        {
            IncreaseDamage = 11,
            IncreaseDefense = 21,
            AntiBurn = 31
        ...
        public enum ReverteDamage : byte
        {
            ByPercent = 11,
            DecreaseMpInsteadOfHp = 41,
            Hmpf = 51,
        }

        public enum ApplyBuffs : byte //bastob -12 reference
        {
            InflictOnAttacking = 21,
            InflictOnDefending = 41,
        }

        public enum GiveBuff : byte
        {
            GiveBuffToEntity = 21,
        }

        public enum DealMoreDamage : byte
        {
            IncreaseDamage = 11,
            IncreaseDamageLoa = 21,
            IncreaseDamageSnake = 31,
            IncreaseDamagePercent = 41
        }

        public enum IncreaseRes : byte
        {
            DecreaseTotalDamageBy = 11,
            Increase300Res = 21,
            IncreaseHpPercent = 31,
            IncreaseDodge = 51,
            IncreaseHitRate = 52,
        }
        public enum A7Powers1 : short
        {
