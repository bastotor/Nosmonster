            ...
            if (mlobj != null)
            {
                ...
                switch (packet.Type)
                {
                    ...
                    case 1:
                        ...
                        if (mlobj.ItemInstance.ItemVNum == 3117 || mlobj.ItemInstance.ItemVNum == 3121 || mlobj.ItemInstance.ItemVNum == 3125)
                        {
                            game = 0;
                        }
                        if (mlobj.ItemInstance.ItemVNum == 3118 || mlobj.ItemInstance.ItemVNum == 3122 || mlobj.ItemInstance.ItemVNum == 3126)
                        {
                            game = 1;
                        }
                        if (mlobj.ItemInstance.ItemVNum == 3119 || mlobj.ItemInstance.ItemVNum == 3123 || mlobj.ItemInstance.ItemVNum == 3127)
                        {
                            game = 2;
                        }
                        if (mlobj.ItemInstance.ItemVNum == 3120 || mlobj.ItemInstance.ItemVNum == 3124 || mlobj.ItemInstance.ItemVNum == 3128)
                        {
                            game = 3;
                        }
                        if (mlobj.ItemInstance.ItemVNum == 3130)
                        {
                            game = 4;
                        }
                        if (mlobj.ItemInstance.ItemVNum == 3131)
                        {
                            game = 5;
                        }
                    ...
                    case 4:
                        ...
                        {
                            if (GetMinilandMaxPoint(game)[packet.Point.Value] < Session.Character.MinigameLog.Score)
                            {
                        ...
                        for (int i = 0; i < amount; i++)
                        {
                            if (packet.Point != null)
                            {
                                ...
                                if (gift != null)
                                {
                                    ...
                                    if (packet.Point < 0 || packet.Point > 4)
                                    {
                                        return;
                                    }
                                    else if (packet.Point == 0)
                                    {
                                        gifts.Add(gift);
                                        mlobj.Level1BoxAmount--;
                                    }
                                    else if (packet.Point == 1)
                                    {
                                        gifts.Add(gift);
                                        mlobj.Level2BoxAmount--;

                                    }
                                    else if (packet.Point == 2)
                                    {
                                        gifts.Add(gift);
                                        mlobj.Level3BoxAmount--;
                                    }
                                    else if (packet.Point == 3)
                                    {
                                        gifts.Add(gift);
                                        mlobj.Level4BoxAmount--;

                                    }
                                    else if (packet.Point == 4)
                                    {
                                        gifts.Add(gift);
                                        mlobj.Level5BoxAmount--;
                                    }
