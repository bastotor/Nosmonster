...
namespace OpenNos.Handler
{
    public class MatePacketHandler : IPacketHandler
    {
        ...
        public DateTime IsPartnerTransforming { get; set; }
        ...
        public void UseSkill(UsePartnerSkillPacket usePartnerSkillPacket)
        {
            ...
            switch (partnerSkill.SkillVNum)
            {
                ...
                //Lucy 
                case 1370:
                    Session.Character.AddBuff(new Buff((short)(2237 + partnerSkill.Level), 5), Session.Character.BattleEntity);
                    break;
        ...
        public void SpecialSkill(UpetPacket upetPacket)
        {
            ...
            Mate attacker = Session.Character.Mates.Find(x => x.IsTeamMember && x.MateType == MateType.Pet);
            if (attacker == null)
            {
                return;
            }
