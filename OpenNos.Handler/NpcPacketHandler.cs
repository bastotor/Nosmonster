...
namespace OpenNos.Handler
{
    public class NpcPacketHandler : IPacketHandler
    {
        ...
        private void GenerateNInvForExtensions(int id)
        {
        ...
        public void Pdtse(PdtsePacket pdtsePacket)
        {
            ...
            if (!Session.HasCurrentMapInstance)
            {
             ...
             if (Session.Character.LastPdtseRequests > 40) //bastoban
           {
               PenaltyLogDTO log = new PenaltyLogDTO
               {
                   AccountId = Session.Account.AccountId,
                   Reason = "Auto mute PdtseRequest Infinite Abuse PL",
