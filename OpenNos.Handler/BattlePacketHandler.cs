...
using OpenNos.GameObject.EventSubscriber;
    ...
    public class BattlePacketHandler : IPacketHandler
    {
        ...
        private void PvpHit(HitRequest hitRequest, ClientSession target)
        {
            if (target?.Character.Hp > 0 && hitRequest?.Session.Character.Hp > 0)
            {
                ...
                double cooldownReduction = Session.Character.GetBuff(CardType.Morale, (byte)AdditionalTypes.Morale.SkillCooldownDecreased)[0]; /*+ Session.Character.GetBuff(BCardType.CardType.Casting,*/
                                                                    /*(byte)AdditionalTypes.Casting.EffectDurationIncreased)[0];//bastob*/
...
#pragma warning disable 4014
                    ...
                    if (battleEntity?.ShellWeaponEffects != null)
                    {
                        foreach (ShellEffectDTO shell in battleEntity.ShellWeaponEffects)
                        {
                            switch (shell.Effect)
                            {
                                ...
                                case (byte)ShellWeaponEffectType.DeadlyBlackout://basto
                                    {
                                        ...
                                        if (ServerManager.RandomNumber() < shell.Value
                                           - (shell.Value
                                                * (battleEntityDefense.ShellArmorEffects?.Find(s =>
                                                ...
                                                + battleEntityDefense.ShellArmorEffects?.Find(s =>
                                                        s.Effect == (byte)ShellArmorEffectType.ReducedAllNegativeEffect)?.Value ?? 0) / 100D))
                                        {
                                            target.Character.AddBuff(buff, battleEntity);
                                        }
                                ...
                                case (byte)ShellWeaponEffectType.MinorBleeding://basto
                                    {
                                ...
                                case (byte)ShellWeaponEffectType.Freeze:
                                    {
                                        ...
                                        if (ServerManager.RandomNumber() < shell.Value
                                           - (shell.Value * (battleEntityDefense?.ShellArmorEffects
                                                                               ?.Find(s =>
        ...
        public void DisposeCycle(ClientSession session)
        {
        ...
        private void TargetHit(int castingId, UserType targetType, int targetId, bool isPvp = false)
        {
            ...
            if (skills != null)
            {
                ...
                if (ski != null)
                {
                    ...
                    if (ski.SkillVNum == 1349)
                    {

                        if (Session.Character.Morph == 43) // forme druide
                        {
                            Session.Character.Speed = 12;
                            Session.Character.Morph = 42;
                            Session.Character.RemoveBuff(895);
                            Session.Character.RemoveBuff(896);
                            ...
                            Session.Character.Skills[1027] = new CharacterSkill
                        ...
                        if (Session.Character.Morph == 3720) // forme druide
                        {
                            Session.Character.Speed = 12;
                            Session.Character.Morph = 42;
                            Session.Character.RemoveBuff(895);
                    ...
                    if (ski.SkillVNum == 1025) // forme ours
                    {
                        if (Session.Character.Morph == 42)
                        {
                            Session.Character.Speed = 12;
                            Session.Character.Morph = 43;
                            Session.Character.RemoveBuff(895);
                            Session.Character.MapInstance.Broadcast(Session.Character.GenerateCMode());
                            Session.Character.Session.SendPackets(Session.Character.GenerateQuicklist());
                            Session.Character.Skills[1027] = new CharacterSkill
                        ...
                        else if (Session.Character.Morph == 43)
                        {
                            Session.Character.Speed = 12;
                            Session.Character.Morph = 42;
                            Session.Character.RemoveBuff(895);
                        ...
                        if (Session.Character.Morph == 3720) // ici léopard ===> Ours
                        {
                            Session.Character.Speed = 12;
                            Session.Character.Morph = 43;
                            Session.Character.RemoveBuff(895);
                    ...
                    if (ski.SkillVNum == 1026) // forme leopard
                    {

                        if (Session.Character.Morph == 42)
                        {
                            Session.Character.Speed = 59;
                            Session.Character.Morph = 3720;
                        ...
                        else if (Session.Character.Morph == 3720)
                        {
                            Session.Character.Speed = 12;
                            Session.Character.Morph = 42;
                            Session.Character.RemoveBuff(895);
                        ...
                        if (Session.Character.Morph == 43) // ici ours ===> léopard
                        {
                            Session.Character.Speed = 19;
                            Session.Character.Morph = 3720;
                            Session.Character.MapInstance.Broadcast(Session.Character.GenerateCMode());
                            Session.Character.Session.SendPackets(Session.Character.GenerateQuicklist());
                            Session.Character.RemoveBuff(896);
                        ...
                        if (ski.SkillVNum == 801)
                        {

                            if (Session.Character.Morph == 1) // morph  fernon sur skill pyj
                            {
                                Session.Character.Speed = 20;
                                Session.Character.Morph = 3574;
                                Session.Character.Size = 10;
                                Session.Character.MapInstance.Broadcast(Session.Character.GenerateCMode());
                                Session.Character.Session.SendPackets(Session.Character.GenerateQuicklist());
                            }
                            else if (Session.Character.Morph == 3574)
                            {
                                Session.Character.Speed = 12;
                                Session.Character.Morph = 1;
                                Session.Character.MapInstance.Broadcast(Session.Character.GenerateCMode());
                                Session.Character.Session.SendPackets(Session.Character.GenerateQuicklist());
                            }
                        ...
                        if (ski.SkillVNum == 802)
                        {

                            if (Session.Character.Morph == 1) // morph Seigneur dragon sur skill pyj
                            {
                                Session.Character.Speed = 20;
                                Session.Character.Morph = 4218;
                                Session.Character.MapInstance.Broadcast(Session.Character.GenerateCMode());
                                Session.Character.Session.SendPackets(Session.Character.GenerateQuicklist());
                            }
                            else if (Session.Character.Morph == 4218)
                            {
                                Session.Character.Speed = 12;
                                Session.Character.Morph = 1;
                                Session.Character.MapInstance.Broadcast(Session.Character.GenerateCMode());
                        ...
                        if (ski.SkillVNum == 803)
                        {

                            if (Session.Character.Morph == 1) // morph  Lucifer sur skill pyj
                            {
                                Session.Character.Speed = 20;
                                Session.Character.Size = 15;
                                Session.Character.Morph = 3553;
                                Session.Character.MapInstance.Broadcast(Session.Character.GenerateCMode());
                                Session.Character.Session.SendPackets(Session.Character.GenerateQuicklist());
                            }
                            else if (Session.Character.Morph == 3553)
                            {
                                Session.Character.Speed = 12;
                                Session.Character.Size = 10;
                                Session.Character.Morph = 1;
                        ...
                        if (ski.SkillVNum == 804)
                        {

                            if (Session.Character.Morph == 1) // morph Caligor sur skill pyj
                            {
                                Session.Character.Speed = 25;
                                Session.Character.Size = 6;
                                Session.Character.Morph = 3305;
                                Session.Character.MapInstance.Broadcast(Session.Character.GenerateCMode());
                                Session.Character.Session.SendPackets(Session.Character.GenerateQuicklist());
                            }
                            else if (Session.Character.Morph == 3305)
                            {
                                Session.Character.Speed = 12;
                                Session.Character.Size = 10;
                                Session.Character.Morph = 1;
                    ...
                    else if (ski.SkillVNum == 797) // Throw fishing rod
                    {
                        ...
                        if (spotInfo.Equals(default(KeyValuePair<FishingSpotsDto, List<FishInfoDto>>)))
                        {
                            Session.SendPacket(Session.Character.GenerateSay("You cannot fish here!", 0));
                            Session.SendPacket(StaticPacketHelper.Cancel(2, targetId));
                            Session.Character.RemoveBuff(850);
                        ...
                        void ateBait()
                        {
                            ...
                            Session.Character.Session.SendPacket(Session.Character.GenerateSay("Ugh, the fish ate the bait!", 0));
                            Session.Character.RemoveBuff(850);
                            DisposeCycle(Session);
                        }

                        Session.Character.FishingCycle = Observable.Interval(TimeSpan.FromSeconds(2)).SafeSubscribe(s =>
                        {
                            if (Session.Character.IsFishing)
                            {
                                ...
                                if (rnd < 50)
                                {
                                    ...
                                    {
                                        Session.Character.IsBiting = true;
                                        Session.Character.Session.CurrentMapInstance?.Broadcast(UserInterfaceHelper.GenerateGuri(6, 30, Session.Character.CharacterId, 30));
                                    }
                                }
                                else
                                {
                    ...
                    else if (ski.SkillVNum == 798)
                    {
                        ...
                        if (!Session.Character.IsBiting)
                        {
                            ...
                            Session.CurrentMapInstance?.Broadcast(UserInterfaceHelper.GenerateGuri(6, 0, Session.Character.CharacterId));
                            Session.SendPacket(StaticPacketHelper.Cancel(0, 2, 1));
                            Session.CurrentMapInstance?.Broadcast(UserInterfaceHelper.GenerateGuri(6, 44, Session.Character.CharacterId));
                            Session.CurrentMapInstance?.Broadcast(UserInterfaceHelper.GenerateGuri(19, 0, Session.Character.CharacterId, 2436));
                            Session.Character.RemoveBuff(850);
                            DisposeCycle(Session);
                            return;
                        }
                    ...
                    sendFishReward:
                        var rnda = ServerManager.RandomDouble();
                        ...
                        foreach (var grouping in fishes)
                        {
                            ...
                            length = ServerManager.RandomNumber<short>((int)selectedReward.MinFishLength, (int)selectedReward.MaxFishLength + 1);
                            break;
                        }
                        ...
                        else
                        {
                            ...
                            Observable.Timer(TimeSpan.FromSeconds(4)).Subscribe(x =>
                            {
                                ...
                                Session.SendPacket("pdti 0");
                                Session.SendPacket(Session.Character.GenerateSay($"You have received this item - {ServerManager.GetItem(fishFound).Name} ({length}cm) x1", 11));
                                ...
                                Session.SendPacket(Session.Character.GenerateFishPacket(FishPacketType.Fishing, fishFound, length));

                                var sp = Session.Character.Inventory.LoadBySlotAndType((byte)EquipmentType.Sp, InventoryType.Wear);

                                if (sp != null && Session.Character.UseSp && sp.SpLevel < ServerManager.Instance.Configuration.MaxSPLevel)
                                {
                        ...
                        && (!s.SubType.Equals((byte)AdditionalTypes.MeditationSkill.CausingChance / 10) || SkillHelper.IsCausingChance(ski.SkillVNum))))
                    {
                        ...
                        bc.ApplyBCards(Session.Character.BattleEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade);
                    }
                    ...
                    if (ski.Skill.SkillVNum == 1098 && ski.GetSkillBCards().FirstOrDefault(s => s.Type.Equals((byte)CardType.SpecialisationBuffResistance) && s.SubType.Equals((byte)AdditionalTypes.SpecialisationBuffResistance.RemoveBadEffects / 10)) is BCard RemoveBadEffectsBcard)
                    {
                        if (Session.Character.BattleEntity.BCardDisposables[RemoveBadEffectsBcard.BCardId] != null)
                        {
                            ...
                            RemoveBadEffectsBcard.ApplyBCards(Session.Character.BattleEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade);
                            Session.SendPacket(StaticPacketHelper.Cancel(2, targetId));
                            return;
                        }
                    }
                    ...
                    if (Session.Character.Mp >= mpCost && Session.Character.Hp > hpCost && Session.HasCurrentMapInstance)
                    {
                        ...
                        if (ski.Skill.TargetType == 1 && ski.Skill.HitType == 1)
                        {
                            ...
                            if (targetRange != 0)
                            {
                                ski.GetSkillBCards().Where(s => (s.Type.Equals((byte)CardType.Buff) && new Buff((short)s.SecondData, Session.Character.Level).Card?.BuffType == BuffType.Good)
                                    ...
                                    .ForEach(s => s.ApplyBCards(Session.Character.BattleEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade));
                            }
                        ...
                        else if (ski.Skill.TargetType == 2 && ski.Skill.HitType == 0 || isSacrificeSkill)
                        {
                            ...
                            if (Session.Character.MapInstance == ServerManager.Instance.ArenaInstance2 && targetEntity.Mate?.Owner != Session.Character && targetEntity != Session.Character.BattleEntity && (Session.Character.Group == null || !Session.Character.Group.IsMemberOfGroup(targetEntity.MapEntityId)))
                            {
                                targetEntity = Session.Character.BattleEntity;
                            }
                            ...
                            ski.GetSkillBCards().ToList().Where(s => !s.Type.Equals((byte)CardType.MeditationSkill)).ToList()
                                .ForEach(s => s.ApplyBCards(targetEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade));
                        ...
                        else if (ski.Skill.TargetType == 1 && ski.Skill.HitType != 1)
                        {
                                        ...
                                        if (clientSessions != null)
                                        {
                                            foreach (ClientSession target in clientSessions)
                                            {
                                                  ...
                                                  && (team == null || team.FirstOrDefault(s => s.Session == Session)?.ArenaTeamType == team.FirstOrDefault(s => s.Session == target.Character.Session)?.ArenaTeamType))
                                                {
                                                    ...
                                                    if (Session.Character.MapInstance == ServerManager.Instance.ArenaInstance2 && (Session.Character.Group == null || !Session.Character.Group.IsMemberOfGroup(target.Character.CharacterId)))
                                                    {
                                                        continue;
                                                    }
                                                    ...
                                                    .ToList().ForEach(s =>
                                                        s.ApplyBCards(target.Character.BattleEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade));
                                        ...
                                        if (mates != null)
                                        {
                                            foreach (Mate target in mates)
                                            {
                                                if (!Session.Character.BattleEntity.CanAttackEntity(target.BattleEntity))
                                                {
                                                    ...
                                                    if (Session.Character.MapInstance == ServerManager.Instance.ArenaInstance2 && (Session.Character.Group == null || !Session.Character.Group.IsMemberOfGroup(target.Owner.CharacterId)))
                                                    {
                                                        continue;
                                                    }
                                                    ...
                                                    ski.GetSkillBCards().ToList().Where(s => !s.Type.Equals((byte)CardType.MeditationSkill))
                                                    .ToList().ForEach(s =>
                                                        s.ApplyBCards(target.BattleEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade));
                                            ...
                                            foreach (MapMonster target in monsters)
                                            {
                                                if (!Session.Character.BattleEntity.CanAttackEntity(target.BattleEntity))
                                                {
                                                    if (target.Owner != null)
                                                    {
                                                        ...
                                                        if (Session.Character.MapInstance == ServerManager.Instance.ArenaInstance2 && (Session.Character.Group == null || !Session.Character.Group.IsMemberOfGroup(target.Owner.MapEntityId)))
                                                        {
                                                            continue;
                                                        }
                            ...
                            ski.GetSkillBCards().ToList().Where(s => !s.Type.Equals((byte)CardType.MeditationSkill)).ToList().ForEach(s => s.ApplyBCards(Session.Character.BattleEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade));
                        }
                            ...
                            else
                            {
                                ...
                                if (monsterToAttack != null)
                                {
                                        ...
                                        new MapCell { X = monsterToAttack.MapX, Y = monsterToAttack.MapY }) <= ski.Skill.Range + 5 + monsterToAttack.Monster.BasicArea)
                                    {
                                        ...
                                        ski.GetSkillBCards().ToList().Where(s => s.CastType == 1).ToList()
                                            .ForEach(s => s.ApplyBCards(monsterToAttack.BattleEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade));
                                ...
                                else if (targetEntity.Mate is Mate mateToAttack)
                                {
                                        ...
                                        <= ski.Skill.Range + 5 + mateToAttack.Monster.BasicArea)
                                    {
                                        ...
                                        ski.GetSkillBCards().ToList().Where(s => s.CastType == 1).ToList().ForEach(s => s.ApplyBCards(mateToAttack.BattleEntity, Session.Character.BattleEntity, levelUpgraded: ski.TattooUpgrade));
            ...
            if (characterSkill.CanBeUsed())
            {
                ...
                if (Session.Character.Mp >= mpCost && Session.Character.Hp > hpCost && Session.HasCurrentMapInstance)
                {
                    ...
                    Observable.Timer(TimeSpan.FromMilliseconds(characterSkill.Skill.CastTime * 100)).Subscribe(o =>
                    {
                        ...
                        .ForEach(s => s.ApplyBCards(Session.Character.BattleEntity, Session.Character.BattleEntity, x, y, levelUpgraded: characterSkill.TattooUpgrade));
